...
RUN go build -mod=vendor -a -installsuffix cgo -ldflags="-w -s" -o /go/bin/nest_exporter
...
LABEL org.label-schema.build-date=$BUILD_DATE \
      ...
      org.label-schema.vcs-url="https://github.com/tnwhitwell/nest_exporter" \
      org.label-schema.docker.cmd="docker run -e NEST_TOKEN=token -p 9264:9264 tnwhitwell/nest_exporter" \
